$(document).ready(function() {
    tinymce.init({
      ...
      toolbar: 'undo redo | insert | styleselect | bold italic  | alignleft aligncenter alignright alignjustify | forecolor backcolor | bullist numlist outdent indent | codesample | removeformat | fullscreen',
...
$(document).ready(function() {
    tinymce.init({
      ...
      toolbar: 'undo redo | insert | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | code | fullscreen',
      content_css: '/backend/tinymce/css/codepen.min.css, /backend/tinymce/css/custom_content.css', /*'//www.tinymce.com/css/codepen.min.css',*/
      statusbar: false,
    });
